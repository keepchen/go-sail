...
func TestPrintSwaggerSummaryInfo(t *testing.T) {
	p0 := SwaggerSummaryInfoParamDeprecated{}
	fmt.Println(PrintSwaggerSummaryInfo(p0))
	t.Log("OK")
	p1 := SwaggerSummaryInfoParamDeprecated{
		Title:            "go-sail",
		Version:          "1.0",
...
func TestPrintSwaggerControllerInfo(t *testing.T) {
	p0 := SwaggerControllerInfoParamDeprecated{
	...
	t.Log("OK")
	p1 := SwaggerControllerInfoParamDeprecated{
